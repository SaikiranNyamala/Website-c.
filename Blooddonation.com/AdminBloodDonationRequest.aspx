...
<asp:Content ID="Content3" ContentPlaceHolderID="body" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BackColor="#DEBA84" CssClass="gv1" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1">
